...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@Solelia" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Parisienne&family=Inter:wght@400;500;600;700;800&display=swap",
      },
